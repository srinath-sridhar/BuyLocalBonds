...
import com.team8.dao.SellBondDao;
import com.team8.responses.OrderResponse;
import com.team8.utils.SessionMgmtUtil;

/**
 * Servlet implementation class SellBond
 */
public class SellBondServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public SellBondServlet() {
		super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		SellBondDao dao = new SellBondDao();
		...
		try {
			...
			bor = dao.sellBond(request.getParameterMap(), customerId, traderId);
